  ...
  return (
    <>
      <View style={styles.timeRangeContainer}>
        ...
        >
          <SkinnedText type="helper">Start</SkinnedText>
          <SkinnedText style={styles.time}>{_timeRange?.[0]}</SkinnedText>
        </Pressable>
        <Pressable
          style={styles.timeContainer}
          onPress={() => showTimePicker('end')}
        >
          <SkinnedText type="helper">End</SkinnedText>
          <SkinnedText style={styles.time}>{_timeRange?.[1]}</SkinnedText>
        </Pressable>
      </View>
