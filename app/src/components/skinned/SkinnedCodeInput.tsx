...
import { SkinnedTextInput } from './SkinnedTextInput'
...
export interface CodeInputHandleProps {
  focus: () => void
}

export const SkinnedCodeInput = forwardRef<
  CodeInputHandleProps,
  Partial<CodeInputProps>
