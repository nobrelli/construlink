...
export interface SkinnedTextInputProps extends TextInputProps {
  label: string
  disabled: boolean
  valid: boolean
...
export const SkinnedTextInput = forwardRef<
  RNTextInput,
  Partial<SkinnedTextInputProps>
>((props: Partial<SkinnedTextInputProps>, ref) => {
  const {
    label,
    disabled,
    valid = true,
...
const useStyles = createStyles(
  (
    ...
    { size }: Pick<SkinnedTextInputProps, 'size'>
  ) => {
    return {
      inputLabel: {
