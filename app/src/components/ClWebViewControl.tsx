...
interface ClWebViewControlProps<T extends string | object> {
  html: string
  label?: string
  routeToEditor?: Href<T>
  valid?: boolean
  disabled?: boolean
  inputWrapperStyle?: StyleProp<ViewStyle>
}

export const ClWebViewControl = <T extends string | object>(
  props: ClWebViewControlProps<T>
) => {
  const {
    html,
    label,
